...
#define VIRNA7A_RX_MAX_RING_SIZE   256
#define VIRNA7A_TX_MAX_RING_SIZE   256

#define VIRNA7A_MAX_FIFO_THRESHOLD 511
#define VIRNA7A_MAX_FIFO_STARVE	511
#define VIRNA7A_MAX_FIFO_STARVE_OFF 511
 ...
 */
#define VIRNA7A_GBIT_TIME  512
#define VIRNA7A_100_TIME   2560
#define VIRNA7A_10_TIME    25600
...
#define VIRNA7A_SUPPORTED (SUPPORTED_10baseT_Half \
...
#define VIRNA7A_INT_NAME_MAX	(IFNAMSIZ + 6)	/* '_g#_xx' */
...
#define VIRNA7A_CB(skb) ((struct gianfar_skb_cb *)((skb)->cb))
...
#define VIRNA7A_RMON_LEN ((sizeof(struct rmon_mib) - 16)/sizeof(u32))
#define VIRNA7A_EXTRA_STATS_LEN (sizeof(struct gfar_extra_stats)/sizeof(u64))

/* Number of stats in the stats structure (ignore car and cam regs)*/
#define VIRNA7A_STATS_LEN (VIRNA7A_RMON_LEN + VIRNA7A_EXTRA_STATS_LEN)

#define VIRNA7A_INFOSTR_LEN 32

struct gfar_stats {
	u64 extra[VIRNA7A_EXTRA_STATS_LEN];
	u64 rmon[VIRNA7A_RMON_LEN];
};
...
#define FSL_VIRNA7_DEV_HAS_GIGABIT		0x00000001
#define FSL_VIRNA7_DEV_HAS_COALESCE		0x00000002
#define FSL_VIRNA7_DEV_HAS_RMON		0x00000004
#define FSL_VIRNA7_DEV_HAS_MULTI_INTR		0x00000008
#define FSL_VIRNA7_DEV_HAS_CSUM		0x00000010
#define FSL_VIRNA7_DEV_HAS_VLAN		0x00000020
#define FSL_VIRNA7_DEV_HAS_EXTENDED_HASH	0x00000040
#define FSL_VIRNA7_DEV_HAS_PADDING		0x00000080
#define FSL_VIRNA7_DEV_HAS_MAGIC_PACKET	0x00000100
#define FSL_VIRNA7_DEV_HAS_BD_STASHING		0x00000200
#define FSL_VIRNA7_DEV_HAS_BUF_STASHING	0x00000400
#define FSL_VIRNA7_DEV_HAS_TIMER		0x00000800
...
struct gfar_priv_grp {
	...
	char int_name_tx[VIRNA7A_INT_NAME_MAX];
	char int_name_rx[VIRNA7A_INT_NAME_MAX];
	char int_name_er[VIRNA7A_INT_NAME_MAX];
};

enum gfar_errata {
	VIRNA7A_ERRATA_74		= 0x01,
	VIRNA7A_ERRATA_76		= 0x02,
	VIRNA7A_ERRATA_A002	= 0x04,
	VIRNA7A_ERRATA_12		= 0x08, /* a.k.a errata eTSEC49 */
};

/* Struct stolen almost completely (and shamelessly) from the FCC enet source
 * (Ok, that's not so true anymore, but there is a family resemblance)
 * The VIRNA7A buffer descriptors track the ring buffers.  The rx_bd_base
