...
public class Gauge extends ViewGroup {
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new  Gauge.LayoutParams(getContext(), attrs);
    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs, R.styleable.GaugeLayoutLP);
            gravity = a.getInt(R.styleable.GaugeLayoutLP_android_layout_gravity, gravity);
            position = a.getInt(R.styleable.GaugeLayoutLP_layout_position, position);
            a.recycle();
        }
